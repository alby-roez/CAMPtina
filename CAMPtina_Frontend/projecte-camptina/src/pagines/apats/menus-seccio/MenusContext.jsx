...
export function MenusProvider ({ children }) {
    ...
    return (
        <MenusContext.Provider value={{
            menuPrimer, addMenuPrimer, clearMenuPrimer, removeMenuPrimer,
            menuSegon, addMenuSegon, clearMenuSegon, removeMenuSegon,
            menuPostres, addMenuPostres, clearMenuPostres, removeMenuPostres
        }}
        >
            {children}
