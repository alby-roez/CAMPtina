...
export const LlistaTorns = () => {
    ...
    const eliminarTorn = (indexEliminar) => {
        ...
        const tornsRestants = tornsDesats.filter((_, index) => index !== indexEliminar);
                            ...
                            <ul key={index} className={className_ul_llista}>
                                <li className={className_li_item_update}>
                                    <button
                                        ...
                                        id={id_bttn_update + index}
                                        name={name_bttn_update + index}
                                ...
                                <li className={className_li_item_aforament}>{torn.aforament_maxim}</li>
                                <li className={className_li_item_horainici}>{torn.hora_inici}</li>
